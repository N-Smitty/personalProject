...
//bcryptjs is used for the hashing of passwords. Passwords are meant to be kept private, and hashing passwords allows us to keep them secure.
...
module.exports = {
  ...
  editProfile: (req, res) => {
    ...
    db.users
      .edit_profile(first_name, last_name, email, user_id)
      .then((user) => {
